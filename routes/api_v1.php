...
use App\Http\Controllers\V1\MinistryBranchController;
use App\Http\Controllers\V1\MinistryController;
use App\Http\Controllers\V1\NotificationController;
use App\Http\Controllers\V1\ReplyController;
use App\Http\Controllers\V1\ReportController;
use App\Http\Controllers\V1\StatisticsController;
use App\Http\Controllers\V1\UserController;
use App\Http\Controllers\V1\UserOTPController;
...
Route::prefix('ministry')
    ...
    ->group(function () {
        ...
        Route::controller(MinistryController::class)->group(function () {
            ...
            Route::get('read', 'read');
            Route::get('readAll', 'readAll')->middleware('role:super_admin');
        ...
        Route::get('{ministry}/complaints', [ComplaintController::class, 'getByMinistry'])
        ...
        Route::get('branch/{branch}/complaints', [ComplaintController::class, 'getByBranch']);
    });
...
Route::prefix('citizen')->middleware(['auth:sanctum', 'active.user'])->controller(CitizenController::class)->group(function () {
    Route::get('read', 'read');
    Route::get('read/{citizen}', 'readOne');
